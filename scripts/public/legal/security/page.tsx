    ...
    <div className="p-8">
      ...
      <div className="max-w-4xl mx-auto bg-elevated-background rounded-2xl shadow-lg p-8">
        <div className="text-muted-text space-y-4">
          ...
          <p>If you believe you have found a security vulnerability in our service, please contact us immediately at security@insighthunter.ai. We will investigate all reports and do our best to fix any issues in a timely manner.</p>
        </div>
      </div>
    </div>
  );
