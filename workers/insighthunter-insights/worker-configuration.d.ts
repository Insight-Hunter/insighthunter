/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bec689c8d63e3e8598ff1d964db01315)
// Runtime types generated with workerd@1.20260317.1 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AISession";
	}
	interface PreviewEnv {
		ENVIRONMENT: "preview";
		ALLOWED_ORIGINS: "https://preview.insighthunter.app";
		JWT_SECRET: string;
		OPENAI_API_KEY: string;
	}
	interface Env {
		ENVIRONMENT: "preview" | "production";
		ALLOWED_ORIGINS: "https://preview.insighthunter.app" | "https://insighthunter.app,https://app.insighthunter.app";
		JWT_SECRET: string;
		OPENAI_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "JWT_SECRET" | "OPENAI_API_KEY" | "CHAT_MODEL" | "EMBED_MODEL" | "SUMMARY_MODEL" | "MAX_TOKENS" | "HISTORY_LIMIT" | "FREE_CHAT_LIMIT" | "PRO_CHAT_LIMIT">> {}
}
