/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c353bd58daef8c5710165275c43a0aed)
// Runtime types generated with workerd@1.20260526.1 2025-03-07 
interface __BaseEnv_Env {
	...
	AUTH_WORKER: Fetcher /* auth-worker */;
	BOOKKEEPING_WORKER: Fetcher /* bookkeeping-worker */;
	PAYROLL_WORKER: Fetcher /* payroll-worker */;
	BIZFORMA_WORKER: Fetcher /* bizforma-worker */;
	SCOUT_WORKER: Fetcher /* scout-worker */;
	PBX_WORKER: Fetcher /* pbx-worker */;
	REPORT_WORKER: Fetcher /* report-worker */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/insighthunter-dispatch/src/index");
	}
