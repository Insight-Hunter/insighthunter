...
6. insighthunter-reports, insighthunter-insights, insighthunter-bizforma,
   insighthunter-payroll, insighthunter-pbx — same pattern: own DO class,
   own schema, `idFromName(userId)`, verify session via auth, check
   `/entitlements` for tier-gated ones (reports/insights/bizforma need
   standard+, payroll/pbx need pro+ or an active add-on).
6. insighthunter-reports, insighthunter-insights, insighthunter-bizforma,
