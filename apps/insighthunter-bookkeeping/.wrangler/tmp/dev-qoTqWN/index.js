...
var src_default = app;
var BookkeepingLedger = class {
  static {
    __name(this, "BookkeepingLedger");
  }
  state;
  storage;
  constructor(state) {
  ...
  async postJournalEntry(scope, draft) {
    ...
    const posted = {
      ...
      source: "MANUAL",
      reference: draft.reference?.trim() || void 0,
      status: "POSTED",
      createdAt: (/* @__PURE__ */ new Date()).toISOString(),
  ...
  async requireInitialized(organizationId) {
  ...
  async loadState(organizationId) {
    const stored = await this.storage.get("ledger_state");
    return stored ?? {
      organizationId,
      initializedAt: null,
      accounts: [],
...
function getScope(organizationId, userId) {
  if (!organizationId) {
...
function ledgerStub(env, organizationId) {
  const id = env.BOOKKEEPING_LEDGER.idFromName(`ledger:${organizationId}`);
  return env.BOOKKEEPING_LEDGER.get(id);
}
__name(ledgerStub, "ledgerStub");
...
__name(parseAccountType, "parseAccountType");
function validateDraft(draft, accounts) {
  ...
  for (const line of draft.lines) {
    let calculateAccountBalance2 = function(type2, debits2, credits2) {
    };
    var calculateAccountBalance = calculateAccountBalance2;
    __name(calculateAccountBalance2, "calculateAccountBalance");
    ...
    switch (type) {
      case "ASSET":
      case "EXPENSE":
        return roundMoney2(debits - credits);
      case "LIABILITY":
      case "EQUITY":
      case "REVENUE":
...
__name(validateDraft, "validateDraft");

// ../../node_modules/.pnpm/wrangler@4.107.0_@cloudflare+workers-types@4.20260702.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@4.107.0_@cloudflare+workers-types@4.20260702.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-kGazVf/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@4.107.0_@cloudflare+workers-types@4.20260702.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-kGazVf/middleware-loader.entry.ts
