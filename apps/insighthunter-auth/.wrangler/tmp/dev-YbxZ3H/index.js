...
// ../../node_modules/.pnpm/hono@4.13.2/node_modules/hono/dist/middleware/cors/index.js
...
async function signJWT(payload, secret) {
  ...
  const enc = /* @__PURE__ */ __name((o) => btoa(JSON.stringify(o)).replace(/=+$/, ""), "enc");
...
async function verifyJWT(token, secret) {
  ...
  const valid = await crypto.subtle.verify("HMAC", key, Uint8Array.from(atob(s), (c) => c.charCodeAt(0)), new TextEncoder().encode(`${h}.${p}`));
  if (!valid) throw new Error("Invalid signature");
  return JSON.parse(atob(p));
}
__name(verifyJWT, "verifyJWT");
var USER_WORKER_SCRIPT = `export default { async fetch(req, env) { return new Response("isolated user worker"); } }`;
var src_default = app;

// ../../node_modules/.pnpm/wrangler@4.123.0_@cloudflare+workers-types@5.20260816.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@4.123.0_@cloudflare+workers-types@5.20260816.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-s8VmuS/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@4.123.0_@cloudflare+workers-types@5.20260816.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-s8VmuS/middleware-loader.entry.ts
