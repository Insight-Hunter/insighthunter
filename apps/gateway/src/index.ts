...
const ROUTE_MAP: Record<string, { origin: string; requiredPlan?: OrgPlan[] }> = {
  ...
  bookkeeping: {
    origin: "https://insighthunter-bookkeeping.workers.dev",
    requiredPlan: ["growth", "pro", "enterprise"],
  },
  insights: { origin: "https://insighthunter-insights.workers.dev" },
  advisor: {
    origin: "https://insighthunter-advisor.workers.dev",
    requiredPlan: ["growth", "pro", "enterprise"],
  },
  reports: {
    origin: "https://insighthunter-report.workers.dev",
    requiredPlan: ["growth", "pro", "enterprise"],
  },
  payroll: {
    origin: "https://insighthunter-payroll.workers.dev",
  ...
  bizforma: {
    origin: "https://insighthunter-bizforma.workers.dev",
    requiredPlan: ["growth", "pro", "enterprise"],
  },
  notifications: { origin: "https://insighthunter-notifications.workers.dev" },
  finops: {
    origin: "https://insighthunter-finops.workers.dev",
    requiredPlan: ["pro", "enterprise"],
  },
...
app.use(
  ...
  cors({
    origin: (origin) => {
      ...
      if (origin.endsWith(".insighthunter.app") || origin === "https://insighthunter.app")
        return origin;
      return null;
    },
    credentials: true,
