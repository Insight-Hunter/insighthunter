...
export const pricing = [
  {
    ...
    cta: 'Start free',
    featured: false,
    bullets: ['Up to 150 monthly transactions', 'Basic bookkeeping views', 'Cash snapshot', 'Single user']
  },
  {
    ...
    cta: 'Choose Standard',
    featured: true,
    bullets: ['Unlimited bookkeeping', 'Payroll for small teams', 'AI insights', 'Forecasting and reports']
  },
  {
    name: 'Insight Pro',
    price: '$129',
    ...
    cta: 'Choose Pro',
    featured: false,
    bullets: ['Everything in Standard', 'Advanced forecasting', 'White-label exports', 'Priority support']
  }
];
