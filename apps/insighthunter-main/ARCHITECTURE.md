...
4. insighthunter-dashboard shell (reads entitlements, renders module tiles —
   next up, and needs to replace the placeholder `?token=` handoff from
   insighthunter-main with a proper cookie exchange, see that app's README)
